                ...
                <tr> 
                  <th scope="row"><?php echo $i; ?></th> 
                    ...
                    <td><?php echo $users[4]; ?></td>
                     ...
                     <td> <button type="submit" class="btn btn-primary btn-round" id="submit" name="submit">
                     <a id="reply" href="adminfeedbacksite.php?id=<?php echo $users[0];?>">Reply</a></button></td>

                     <?php
          if(!empty($users['reply']))
          {
          ?>
