          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header ">
                <h5 class="card-title">PLAY KIDS GAME </h5>
                <p class="card-category"></p>
              </div>
              <div class="card-body ">
                <div class="row">
              <div class="col-md-4 block" style="position: relative";>
              <a target="_blank" href="https://www.cartoonnetworkhq.com/games/craig-of-the-creek-capture-the-flag/play"><img src="games/capturetheflag.webp"  style=" width: 500px;
                        height: 400px;"> </a>
                </div>
               <div class="col-md-4 block" style="position: relative";>
              <a target="_blank" href="https://www.cartoonnetworkhq.com/games/victor-and-valentino-monster-kicks/play"><img src="games/monsterkicks.webp"  style=" width: 500px;
                        height: 400px;"> </a>
               </div>
               <div class="col-md-4 block" style="position: relative";>
              <a target="_blank" href="https://www.cartoonnetworkhq.com/games/teen-titans-go-jump-jousts-2/play"><img src="games/g1.webp"  style=" width: 500px;
                        height: 400px;"> </a>
              </div>
              </div>
