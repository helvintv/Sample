      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Paper Dashboard 1</a>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card ">
              ...
              <h5 class="card-title">KIDS STORIES </h5>
              ...
              <a href="https://youtu.be/uwzViw-T0-A"><img src="games/crowtitle.jpg"  style=" width: 500px;
                        height: 400px;"> </a>
                </div>
               <div class="col-md-6 block" style="position: relative";>
              <a href=""><img src="games/crow.jpg"  style=" width: 500px;
                        height: 400px;"> </a>
               </div>   
              </div>
              ...
              <div class="row" >
              <div class="col-md-6 block" style="position: relative";>
              <a href="https://youtu.be/bw_5JfrQ-aE"><img src="games/foxtitle.jpg"  style=" width: 500px;
                        height: 400px;"> </a>
                </div>
               <div class="col-md-6 block" style="position: relative";>
              <a href=""><img src="games/fox.jpg"  style=" width: 500px;
                        height: 400px;"> </a>
               </div>   
              </div>
