          ...
          <div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Doctor feedback</h5>
              </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="doctor" name="doctor" placeholder="Doctor">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Department of the Doctor</label>
                        <input type="text" class="form-control" id="dept" name="dept" placeholder="Department" >
                      </div>
                    </div>
					<div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Which Hospital</label>
...
{  
  ...
  $sql="insert into feedbackdoctor(username,email,doctor,dept,hospital,message,reply)
 values('$username','$email','$doctor','$dept','$hospital','$message','')";
