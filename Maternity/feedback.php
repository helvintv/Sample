      ...
      <div class="content">
        ...
        <div class="row">
          <div class="col-md-4">
           ...
           <div class="card">
              <div class="card-header">
                <center><h4 class="card-title">Doctor Feedback</h4></center>
              </div>
              <a href="feedback_doctor.php"><div class="card-body">
                <ul class="list-unstyled team-members">
				<center><h6> Feedback about the doctor</h6></center>
		  ...
		  <div class="col-md-4">
           ...
           <div class="card">
              <div class="card-header">
                <center><h4 class="card-title">Product Feedback</h4></center>
              </div>
              <a href="feedback_product.php"><div class="card-body">
                <ul class="list-unstyled team-members">
				<center><h6>Feedback about the product</h6></center>
                  <center><a href="View_.php"><img src="images/product.png"></a></center>
                </ul>
              </div></a>
            </div>
          </div>
		  <div class="col-md-4">
           ...
           <div class="card">
              <div class="card-header">
                <center><h4 class="card-title">General Feedback</h4></center>
              </div>
              <a href="feedback_site.php"><div class="card-body">
                <ul class="list-unstyled team-members">
				
				  <center><h6> General feedback about the website working</h6></center>
...
{  
  ...
  $sql="insert into feedback(username,email,message,reply)
