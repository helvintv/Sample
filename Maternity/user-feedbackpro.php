          ...
          <div class="col-md-8">
            <div class="card card-user">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label id="name" name="name">Username - <?php echo $row['name'];?> </label>
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email - <?php echo $row['email'];?> </label>
                      </div>
                    </div>
                  </div>
              ...
              <tbody> 
                ...
                include("Connection.php");
                  $users = 0;
                  $sql2 = "select * from feedbackproduct where email ='$email'";
                ...
                <tr> 
                  ...
                  <th scope="row"><?php echo date("Y-m-d") . "<br>";?></th> 
